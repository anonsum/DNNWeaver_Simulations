...
### J: For dnnweaver - drone 
#import yolo2_tiny_tf 
#import dnn_fpga 
...
def main():
   ...
   # fpga_touts, fxp_fpga_touts = run_fpga(fpga_tin, bf_weight_pickle) #Trying to run on fpga 
   ...
   # result = get_bbox(tfnet, fpga_touts["conv8"][0][0], h, w)  #obtaining the results from fpga computations.
    result = get_bbox(tfnet, my_touts["conv8"][0], h, w ) # Obatating the results from cpu computations.  
