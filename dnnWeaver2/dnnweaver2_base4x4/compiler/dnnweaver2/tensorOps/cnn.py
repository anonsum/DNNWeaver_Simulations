...
class Convolution(NodeOp):
    def __init__(self, data, weights, bias, node_name, pad='SAME', stride=None, group=1, dtype=FQDtype.FP32, branched=False):
...
class Concat(NodeOp):
    ...
    def _get_output_shape(self):
        ...
        for _data in self.data:
            ic_padded = int(math.ceil(_data.shape[self.concat_dim]/(4.0))*4.0) #FIX
            concat_dim += ic_padded                                            #FIX
        out_shape = []
