...
class BFInstruction(object):
    ...
    def get_binary(self):
        ...
        binary+= int(self.immediate)
#        print('MS: opcode:{}, op_spec: {}, loopid:{}, imm:{}, Instr: {}'.format(hex(self.op_code),hex(self.op_spec),hex(self.loop_id),(self.immediate),hex(binary)))
        return binary
...
class BaseAddressInstruction(BFInstruction):
    ...
    def __init__(self, scratchpad_ID, index, address):
        ...
        op_spec += self.index
#        print('MS: BaseAddrInstr, Opcode: {}, opspec :{}, imm:{}'.format(OPCodes.BASE_ADDR,hex(op_spec),hex(immediate)))
...
#        print('MS: LoopInstr.. opcode:{}, looplevel:{}, loopid:{}, loopiter:{}'.format(OPCodes.LOOP,loop_level,loop_id,loop_iterations))
...
#        print('MS: SetupInstr constructor.OPCodes.SETUP:{},  (op0_bw_spec,op1_bw_spec,op_spec): ({},{},{})'.format(OPCodes.SETUP,self.op0_bitwidth_spec,self.op1_bitwidth_spec,hex(op_spec)))
...
#        print('MS: Gen Addr Low.op_code:{}, op_spec:{}. loop_id:{},imm:{}'.format(OPCodes.GENADDRLO,hex(op_spec),hex(loop_id),hex(immediate)))
...
#        print('MS: Gen Addr High .op_code:{}, op_spec:{}. loop_id:{},imm:{}'.format(OPCodes.GENADDRHI,hex(op_spec),hex(loop_id),hex(immediate)))
        # print('Scratchpad {}, ldst: {}, loop_id: {}, stride: {}'.format(scratchpad_ID, ld_st, loop_id, immediate))
